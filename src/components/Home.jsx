      ...
      <div className="query-container">
        ...
        <div className="desc-container">
          ...
          <p className="desc">
            ...
            Consequatur, quasi eveniet! Autem adipisci aut ea maxime laudantium!
          </p>

          <p className="desc">
            Quasi autem natus tenetur beatae libero est repellat facere. Illum,
            eaque deleniti! Lorem ipsum dolor sit amet consectetur, adipisicing
            elit. Excepturi cum sunt corporis aperiam sint! Deserunt similique
            aliquam iure! Totam temporibus tenetur cupiditate iste asperiores
            perferendis tempore vel quod quos laboriosam.
          </p>
          <button className="btn-primary">
